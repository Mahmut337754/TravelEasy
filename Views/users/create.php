...
<head>
    ...
    <title>Gebruiker toevoegen - TravelEasy</title>
    ...
    <div class="container mt-4">
        ...
        <form method="POST" action="/users/store">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" name="name" value="<?= $_SESSION['old_input']['name'] ?? '' ?>" required>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">E-mailadres</label>
                <input type="email" class="form-control" id="email" name="email" value="<?= $_SESSION['old_input']['email'] ?? '' ?>" required>
            </div>
            <div class="mb-3">
